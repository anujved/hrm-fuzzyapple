...
function createData(expensetype) {
  return { expensetype };
}

const rows = [createData("Event"), createData("Extra Expense")];
    ...
    <div className={classes.root}>
      <Box py={3} px={5}>
        <Grid container justifyContent="space-between">
          <Typography variant="h5">Manage Expense Type</Typography>
          <Button
            variant="contained"
