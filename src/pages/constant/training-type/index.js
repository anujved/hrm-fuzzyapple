...
function createData(trainingtype) {
  return { trainingtype };
}

const rows = [createData("Job Training"), createData("Workshop")];
    ...
    <div className={classes.root}>
      <Box py={3} px={5}>
        <Grid container justifyContent="space-between">
          <Typography variant="h5">Manage Training Type</Typography>
          <Button
            variant="contained"
