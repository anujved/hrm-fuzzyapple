...
function createData(jobcategory) {
  return { jobcategory };
}

const rows = [createData("Accounting Jobs"), createData("Business Jobs")];
    ...
    <div className={classes.root}>
      <Box py={3} px={5}>
        <Grid container justifyContent="space-between">
          <Typography variant="h5">Manage Job Category</Typography>
          <Button
            variant="contained"
