...
function createData(paymenttype) {
  return { paymenttype };
}

const rows = [createData("Bank"), createData("Cash")];
    ...
    <div className={classes.root}>
      <Box py={3} px={5}>
        <Grid container justifyContent="space-between">
          <Typography variant="h5">Manage Payment Type</Typography>
          <Button
            variant="contained"
