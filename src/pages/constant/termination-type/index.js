...
function createData(terminationtype) {
  return { terminationtype };
}

const rows = [createData("Test Termination"), createData("Voluntary Termination")];
    ...
    <div className={classes.root}>
      <Box py={3} px={5}>
        <Grid container justifyContent="space-between">
          <Typography variant="h5">Manage Termination Type</Typography>
          <Button
            variant="contained"
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.terminationtype}</TableCell>
                        ...
                        >
                          <IconButton
                            onClick={(event) => {
                              ...
                              setEditValue(row.terminationtype);
                              setIsEdit(true);
                              setOpenDialog(true);
                            }}
                          >
                            <EditIcon style={{ color: "#60C6FF" }} />
                          </IconButton>
                          <IconButton
                            onClick={(event) => {
                              event.stopPropagation();
                          ...
                          >
                            <DeleteForeverIcon style={{ color: "#F62E51" }} />
                          </IconButton>
                        </Grid>
                      </TableCell>
                    </TableRow>
