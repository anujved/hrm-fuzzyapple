...
import BulkAttendanceFilterView from './BulkAttendanceFilterView';
...
const ManageBulkAttendance = (props) => {
  ...
  return (
    <React.Fragment>
      <Helmet>Manage Bulk Attendance</Helmet>
      <Box
        sx={{
...
export default ManageBulkAttendance;
