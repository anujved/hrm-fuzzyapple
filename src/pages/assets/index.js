...
const Assets = (props) => {
  ...
  return (
    <React.Fragment>
                  ...
                  <TableBody>
                    {payslips.slice(0, limit).map((payslip) => (
                      ...
                      >
                        ...
                        <TableCell>{payslip.purchaseDate}</TableCell>
                        <TableCell>{payslip.supportUntil}</TableCell>
      ...
      <CreateAssetsModal open={openDialog} onCloseClickListener={onDialogCloseClickListener} />
    </React.Fragment>
  );
};
