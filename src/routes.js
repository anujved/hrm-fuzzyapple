  ...
  const routes = [
    {
      ...
      children: [
        ...
        { path: "/staff/role", element: requireAuthRoute(Role) },
        {
          ...
          element: requireAuthRoute(EmployeeProfile),
        },
        ...
        { path: "/payroll/set-salary", element: requireAuthRoute(SetSalary) },
        {
          ...
          element: requireAuthRoute(SalaryDetailView),
        },
        { path: "/payroll/pay-slip", element: requireAuthRoute(Payslip) },

        /** Timesheet */
        {
          path: "/timesheet/manage-timesheet",
          element: requireAuthRoute(TimeSheet),
        },
        {
          path: "/timesheet/manage-leave",
          element: requireAuthRoute(ManageLeave),
        },
        {
          path: "/timesheet/attendance/manage-marked-attendance",
          element: requireAuthRoute(ManageMarkedAttendance),
        },
        {
          path: "/timesheet/attendance/manage-bulk-attendance",
          element: requireAuthRoute(ManageBulkAttendance),
        },

        /** Performance */
        {
          path: "/performance/indicator",
          element: requireAuthRoute(Indicator),
        },
        {
          path: "/performance/appraisal",
          element: requireAuthRoute(Appraisal),
        },
        {
          path: "/performance/goal-tracking",
          element: requireAuthRoute(GoalTracking),
        },

        /** Finance */
        {
          path: "/finance/account-list",
          element: requireAuthRoute(FinanceAccount),
        },
        ...
        {
          path: "/finance/transfer-balance",
          element: requireAuthRoute(TransferBalance),
        },

        /** Training */
        {
          path: "/training/training-list",
          element: requireAuthRoute(TrainingList),
        },
        ...
        { path: "/recruitment/jobs", element: requireAuthRoute(Jobs) },
        {
          ...
          element: requireAuthRoute(CreateJob),
        },

        /** Ticket */
        { path: "/dashboard/ticket", element: requireAuthRoute(Ticket) },
        {
          path: "/dashboard/ticket/reply",
          element: requireAuthRoute(TicketReply),
        },
        ...
        /** Client */
        { path: "/dashboard/client", element: requireAuthRoute(Client) },
        ...
        /** Company Policy */
        {
          ...
          element: requireAuthRoute(CompanyPolicy),
        },
        ...
        {
          path: "/constant/designation",
          element: requireAuthRoute(Designation),
        },
        {
          path: "/constant/document-type",
          element: requireAuthRoute(DocumentType),
        },
        {
          path: "/constant/award-type",
          element: requireAuthRoute(ConstantAward),
        },
        {
          path: "/constant/payslip-type",
          element: requireAuthRoute(PayslipType),
        },
        {
          path: "/constant/allowance-option",
          element: requireAuthRoute(AllowanceOption),
        },
        {
          path: "/constant/loan-option",
          element: requireAuthRoute(LoanOption),
        },
        {
          path: "/constant/deduction-option",
          element: requireAuthRoute(DeductionOption),
        },
        {
          path: "/constant/expense-type",
          element: requireAuthRoute(ExpenseType),
        },
        {
          path: "/constant/income-type",
          element: requireAuthRoute(IncomeType),
        },
        {
          path: "/constant/payment-type",
          element: requireAuthRoute(PaymentType),
        },
        { path: "/constant/leave-type", element: requireAuthRoute(LeaveType) },
        {
          path: "/constant/termination-type",
          element: requireAuthRoute(TerminationType),
        },
        { path: "/constant/goal-type", element: requireAuthRoute(GoalType) },
        {
          path: "/constant/training-type",
          element: requireAuthRoute(TrainingType),
        },
        {
          path: "/constant/job-category",
          element: requireAuthRoute(JobCategory),
        },

        /** Report Routes */
        {
          path: "/report/monthly-attendance",
          element: requireAuthRoute(MonthlyAttendance),
        },
